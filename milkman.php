...
$sql = "INSERT INTO `www`.`milkman` ( `name`, `gender`, `age`, `email`, `phone`, `des`,`date`) VALUES ('$name', '$gender', '$myage', '$email', '$phone', '$desc', current_timestamp())";


//INSERT INTO `milkman` (`srno`, `name`, `gender`, `age`, `email`, `phone`, `des`, `date`) VALUES ('1', 'a', 'a', '8', 'a', '55', 'aa', current_timestamp());
...
<head>
    ...
    <link rel="stylesheet" href="css/milkman.css">
...
<div style="display: inline-flex;"  class="don">
    <div class="ming">
        <img  style="height: 400px; margin-top: 20px;" src="img/omilk.jpeg">
    </div>

    <div class="formc">
        <h1>Welcome To Milkman Registration Form</h1>
        <p style="margin-top: 20px;">Enter Your Deatails And Submit This Form To Milkman Registration</p>
        <!-- <p class="submitMsg">Thank for submitting your form .We are happy to see you joining us for the us trip</p> -->

        <!-- ctreating a Form -->
        <form action="milkman.php" method="post">
