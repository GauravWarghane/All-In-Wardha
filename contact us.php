...
$sql = "INSERT INTO `www`.`contact us` ( `name`, `gender`, `age`, `email`, `phone`, `des`,`date`) VALUES ('$name', '$gender', '$myage', '$email', '$phone', '$desc', current_timestamp())";


//INSERT INTO `contact us` (`srno`, `name`, `gender`, `age`, `email`, `phone`, `des`, `date`) VALUES ('1', 'rajesh', 'male', '88', 'gfdf@gmail.com', '7552222', '121', current_timestamp());
...
<head>
    ...
    <title>Wardha Wide Wonder</title>
    ...
    <div class="navbar">
        ...
        <nav id="navbar">
            ...
            <ul>
                ...
                <li class="item"><a href="find a job.php">Find A Job</a></li>
                <li class="item"><a id="cnt" href="contact us.php">Contact Us </a></li>
...
<div style="display: inline-flex;" class="donc">

    <div class="fimgf">

        <img style="height: 400px; margin-top: 70px; " src="img/ocontact us.jpeg">
    </div>
    <div class="formc">
        <h1>Welcome To Contact Us</h1>
        <p style="margin-top: 20px;">Enter Your Deatails And Submit This Form To Contacts Us.</p>
        ...
        <form action="contact us.php" method="post">
            ...
            <button id="click" onclick="clicked();" class="btnm">Submit</button>
