...
$sql = "INSERT INTO `www`.`mechanics` ( `name`, `gender`, `age`, `email`, `phone`, `des`,`date`) VALUES ('$name', '$gender', '$myage', '$email', '$phone', '$desc', current_timestamp())";


//INSERT INTO `mechanics` (`srno`, `name`, `gender`, `age`, `email`, `phone`, `des`, `date`) VALUES ('1', 'as', 'as', '22', 'gfdf@gmail.com', '7552222', '4545', current_timestamp());
...
<div  style="display: inline-flex;" class="donn">
    <div  class="imgm">
    <img style="height: 500px;" src="img/mech.jpg">
</div>
    <div class="formc">
        <h1>Welcome To Mechanics Services</h1>
        <p style="margin-top: 20px;">Enter Your Deatails And Submit This Form To Register For Mechanics.</p>
