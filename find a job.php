...
$sql = "INSERT INTO `www`.`find a job` ( `name`, `gender`, `age`, `email`, `phone`, `des`,`date`) VALUES ('$name', '$gender', '$myage', '$email', '$phone', '$desc', current_timestamp())";
...
<!-- Adding backgound  image -->
    ...
    <div style="display: inline-flex;";" class="donf">
<div class="fimg">
    <img style="height: 500px; margin-top: 30px;" src="img/ofindj.jpeg">
</div>
    <div class="formc">
        <h1>Welcome To Find A Job Services </h1>
        <p style="margin-top: 20px;">Enter Your Deatails And Submit This Form To Register For Job</p>
        <!-- <p class="submitMsg">Thank for submitting your form .We are happy to see you joining us for the us trip</p> -->

        <!-- ctreating a Form -->
        <form action="find a job.php" method="post">
